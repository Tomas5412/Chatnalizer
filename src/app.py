...
def startChatnalisis():
    try:
        ...
        message = analizeChat(filename.get(), excludeAI=aistate.get(), dateStart=dStart, dateEnd=dEnd, dateType=dType, phraseList=wordList, caseSensitive=caseSensitive.get())
