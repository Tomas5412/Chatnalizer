    ...
    if messages == []:
        ...
        match language:
            case "SPANISH":
                ...
                c.cell(0,LINE_SPACING,f"El tamaño promedio de mensaje es de {(sum([m.avgMessageLength for m in groupChat.members]) / len(groupChat.members)):.2f} letras por mensaje.", new_x="LMARGIN", new_y="NEXT")
